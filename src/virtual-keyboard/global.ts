...
if (isBrowser() && !('mathVirtualKeyboard' in window)) {
  ...
  //   });
  // }
  // Temporary workaround for issue mathkeyboard won't show up in iframe by using VirtualKeyboard singleton in iframe case as well. Might affect use case when there are multiple iframes in an app
